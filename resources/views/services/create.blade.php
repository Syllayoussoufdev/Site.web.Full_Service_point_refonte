    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 shadow sm:rounded-lg">
                <h2 class="text-lg font-medium mb-4">Ajouter un nouveau service</h2>
                ...
                <form action="{{ route('services.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nom" class="block w-full border-gray-300 rounded-md" required>
                    </div>

                    <!-- Description -->
                    <div class="mb-4">
                        <label>Description</label>
                        <textarea name="description" class="block w-full border-gray-300 rounded-md" required></textarea>
                    </div>
                    ...
                    <div class="flex gap-4 mb-4">
                        <div class="flex-1">
                            <label>Prix :</label>
                            <input type="number" step="0.01" name="prix" class="block w-full border-gray-300 rounded-md">
                        </div>
                        <div class="flex items-center mt-6">
                            <input type="hidden" name="prix_sur_devis" value="0">
                            <input type="checkbox" name="prix_sur_devis" value="1" class="rounded">
